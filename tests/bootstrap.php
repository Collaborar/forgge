...
class Forgge_Tests_Bootstrap {
	/**
	 * The bootstrap instance.
	 *
	 * @var Forgge_Tests_Bootstrap
	 */
	...
	private function __construct() {
		...
		define( 'FORGGE_TEST_DIR', $this->tests_dir );
...
Forgge_Tests_Bootstrap::instance();

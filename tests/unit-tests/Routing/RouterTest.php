...
/**
 * @coversDefaultClass \Forgge\Routing\Router
 */
class RouterTest extends TestCase {
	public function set_up() {
		$this->condition_factory = new ConditionFactory( [
			'url' => \Forgge\Routing\Conditions\UrlCondition::class,
			'custom' => \Forgge\Routing\Conditions\CustomCondition::class,
			'multiple' => \Forgge\Routing\Conditions\MultipleCondition::class,
			'negate' => \Forgge\Routing\Conditions\NegateCondition::class,
		] );

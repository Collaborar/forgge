...
use Forgge\Routing\Conditions\PostIdCondition;
use Forgge\Routing\Conditions\UrlCondition;
use ForggeTestTools\TestCase;

/**
 * @coversDefaultClass \Forgge\Routing\Conditions\ConditionFactory
 */
class ConditionFactoryTest extends TestCase {
	...
	public function set_up() {
		...
		$app->bootstrap( [], false );
		$condition_types = $app->resolve( FORGGE_ROUTING_CONDITION_TYPES_KEY );

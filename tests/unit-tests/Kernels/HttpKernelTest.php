...
/**
 * @coversDefaultClass \Forgge\Kernels\HttpKernel
 */
class HttpKernelTest extends TestCase {
	...
	public function testFilterTemplateInclude_Response_Override() {
		...
		$this->container->shouldReceive( 'offsetSet' )
			->with( FORGGE_RESPONSE_KEY, $response );

		$this->assertEquals( FORGGE_DIR . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'view.php', $subject->filterTemplateInclude( '' ) );
	}
	...
	public function testFilterTemplateInclude_NoResponseWithComposers_Compose() {
		...
		$this->assertEquals( FORGGE_DIR . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'view.php', $subject->filterTemplateInclude( $template ) );
	}
